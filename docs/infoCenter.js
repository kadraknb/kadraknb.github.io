const info = {
  ...
  conhecimento: {
    ...
    conteudo: [
      'TypeScript, JavaScript, Python, Bash, SQL, HTML e CSS.',
      'React, Vue, Router, Redux, Context API, Hooks.',
      'NodeJS, Express, FS, MySQL, Sequelize, MongoDB, Docker.',
      'Jest, RTL, PyTest, Mocha, Chai, Sinon.',
      'Scrum, Kanban.',
    ],
  },
